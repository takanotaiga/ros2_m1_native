...
sanitize_runtime_env() {
  ...
  unset PYTHONHOME
  unset PYTHONPATH
  unset ROS2_M1_NATIVE_COLCON_DEFAULTS_FILE
  unset ROS2_M1_NATIVE_PYTHON_CONFIG_EXECUTABLE
  unset ROS2_M1_NATIVE_PYTHON_EXECUTABLE
  unset ROS2_M1_NATIVE_PYTHON_INCLUDE_DIR
  unset ROS2_M1_NATIVE_PYTHON_LIBRARY
  unset ROS2_M1_NATIVE_PYTHON_ROOT_DIR
  unset ROS2_M1_NATIVE_ROOT
  unset ROS2_LOCAL_DEPS_PREFIX
  unset ROS2_THIRD_PARTY_SRC_DIR
  unset VIRTUAL_ENV
}
...
if [[ -x "${ROS2_M1_NATIVE_PYTHON_EXECUTABLE}" ]]; then
  ...
  ROS2_M1_NATIVE_PYTHON_CONFIG_EXECUTABLE="$(dirname "${ROS2_M1_NATIVE_PYTHON_EXECUTABLE}")/python3-config"
  ROS2_M1_NATIVE_PYTHON_LIBRARY="$(resolve_python_library "${RUNTIME_PREFIX}/python" "${ROS2_M1_NATIVE_PYTHON_EXECUTABLE}")"
  export ROS2_M1_NATIVE_PYTHON_ROOT_DIR
  export ROS2_M1_NATIVE_PYTHON_INCLUDE_DIR
  export ROS2_M1_NATIVE_PYTHON_CONFIG_EXECUTABLE
...
build:
  cmake-args:
    ...
    - -DPYTHON_CONFIG_EXECUTABLE=${ROS2_M1_NATIVE_PYTHON_CONFIG_EXECUTABLE}
    - -DPythonExtra_INCLUDE_DIRS=${ROS2_M1_NATIVE_PYTHON_INCLUDE_DIR}
    - -DPythonExtra_LIBRARIES=${ROS2_M1_NATIVE_PYTHON_LIBRARY}
